...
public interface ORSView {
	...
	public String DEMO_VIEW = PAGE_FOLDER + "/DemoView.jsp";
	public String DEMO_LIST_VIEW = PAGE_FOLDER + "/DemoListView.jsp";
	...
	public String PURCHASE_ORDER_LIST_VIEW = PAGE_FOLDER + "/PurchaseOrderListView.jsp";
	...
	public String DEMO_CTL = APP_CONTEXT + "/ctl/DemoCtl";
	public String DEMO_LIST_CTL = APP_CONTEXT + "/ctl/DemoListCtl";

	public String PURCHASE_ORDER_CTL = APP_CONTEXT + "/ctl/PurchaseOrderCtl";
	public String PURCHASE_ORDER_LIST_CTL = APP_CONTEXT + "/ctl/PurchaseOrderListCtl";
