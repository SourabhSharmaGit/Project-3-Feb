...
public final class ModelFactory {
	...
	public MedicationModelInt getMedicationModel() {
		...
		if (medicationModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				medicationModel = new MedicationModelHibImp() {
				};
			}
	...
	public DemoModelInt getDemoModel() {
		DemoModelInt demoModel = (DemoModelInt) modelCache.get("demoModel");
		if (demoModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				demoModel = new DemoModelHibImp() {
				};
			}
			
			modelCache.put("demoModel", demoModel);
		}
		return demoModel;
	}
