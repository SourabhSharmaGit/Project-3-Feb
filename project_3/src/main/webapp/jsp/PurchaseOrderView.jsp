...
<title>PurchaseOrder View</title>
...
<body class="hm">
	...
	<main>
	<form action="<%=ORSView.PURCHASE_ORDER_CTL%>" method="post">
		<jsp:useBean id="dto"
			...
			<div class="col-md-4 mb-4">
				<div class="card input-group-addon">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<div class="input-group-text">
										<i class="fa fa-PurchaseOrder-alt grey-text"
					...
					: DataUtility.getStringData(dto.getQuantity())%>">
						...
						<span class="pl-sm-5"><b>My Date</b> <span
							style="color: red;">*</span></span></br>
						<div class="col-sm-12">
							<div class="input-group">
								<div class="input-group-prepend">
								...
								<input type="text" id="datepicker2" name="myDate"
									class="form-control" placeholder=" Enter orderDate "
									readonly="readonly"
									value="<%=DataUtility.getDateString(dto.getCreatedDatetime())%>">
