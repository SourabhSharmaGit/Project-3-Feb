		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Demo</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.DEMO_CTL%>"><i
							class="fas fa-user-circle"></i>Add Demo</a> <a class="dropdown-item"
							href="<%=ORSView.DEMO_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Demo List</a>
					</div></li>
					
				<%-- 	<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Purchase Order</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.PURCHASE_ORDER_CTL%>"><i
							class="fas fa-user-circle"></i>Add Order</a> <a class="dropdown-item"
							href="<%=ORSView.PURCHASE_ORDER_LIST_CTL%>"><i
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Stock Purchase</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.STOCK_PURCHASE_CTL%>"><i
							class="fas fa-user-circle"></i>Add Stocks</a> <a class="dropdown-item"
							href="<%=ORSView.STOCK_PURCHASE_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Stock List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.ITEM_CTL%>"><i
							...
							href="<%=ORSView.ITEM_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Item List</a>
					</div></li> --%>
					
					<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Medication</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						<a class="dropdown-item" href="<%=ORSView.MEDICATION_CTL%>"><i
							class="fas fa-user-circle"></i>Add Medication</a> <a class="dropdown-item"
							href="<%=ORSView.MEDICATION_LIST_CTL%>"><i
							class="fas fa-user-friends"></i>Medication List</a>
					</div></li>
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
